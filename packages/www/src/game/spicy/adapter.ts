...
import { spicyClientMessageSchema } from "./messages";
...
export const spicyRegistration: GameAdapterRegistration = {
    gameTypes: ["spicy"],
    create: (_gameType, stateRef, _adapterCtx) => {
        ...
        return {
            ...
            processMessage: (msg, broadcast, sendTo) =>
                spicyServer(ref).processMessage(msg as SpicyClientMessage, broadcast, sendTo),
